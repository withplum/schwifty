...
latex_documents = [
    (master_doc, "Schwifty.tex", u"Schwifty Documentation", u"Martin Domke", "manual"),
]
...
man_pages = [(master_doc, "schwifty", u"Schwifty Documentation", [author], 1)]
