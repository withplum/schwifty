...
def runtime_test_split_bank_name():
    """
    Run tests against split_bank_name function. In case there is pattern which is not covered by the function, add it
    to the patterns list in the function.
    """
    test_cases = [
        ...
        ("MEDIOCREDITO TRENTINO-ALTO ADIGE - S.P.A. (IN LINGUA TEDESCAINVESTITIONSBANK TRENTINO-SUDTIROL - A.G.)",
         ("MEDIOCREDITO TRENTINO-ALTO ADIGE - S.P.A.", None)),
        ("BANCA POPOLARE DELL'ETRURIA E DEL LAZIO - SOCIETA' COOPERATIVA (IN BREVE BANCAETRURIA SOCIETA' COOPERATIVA)",
         ("BANCA POPOLARE DELL'ETRURIA E DEL LAZIO - SOCIETA' COOPERATIVA", "BANCAETRURIA SOCIETA' COOPERATIVA")),
        ("CASSA DI RISPARMIO DI ASTI S.P.A. (IN FORMA ABBREVIATA BANCA C.R. ASTI S.P.A.), Filiale di Treviso",
         ("CASSA DI RISPARMIO DI ASTI S.P.A.", "BANCA C.R. ASTI S.P.A.")),
        (
        "BANCA PICCOLO CREDITO VALTELLINESE, SOCIETA' COOPERATIVA (OVVERO CREDITO VALTELLINESE S.C. O SOLO CREDITO VALTELLINESE)",
        ("BANCA PICCOLO CREDITO VALTELLINESE, SOCIETA' COOPERATIVA", "CREDITO VALTELLINESE S.C.")),
        (
            "BANCA DI CREDITO COOPERATIVO - BANCA DI SIRACUSA IN SIGLA BCC BANCA DI SIRACUSA - SOCIETA' COOPERATIVA",
            ("BANCA DI CREDITO COOPERATIVO - BANCA DI SIRACUSA", "BCC BANCA DI SIRACUSA - SOCIETA' COOPERATIVA")
        )
    ]
    ...
    for input_str, expected_output in test_cases:
        ...
        # print(f"Actual output: {split_bank_name(input_str)}")
